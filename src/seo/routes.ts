...
export const routes: RouteDefinition[] = [
  ...
  {
    ptPath: '/transparencia-ia',
    enPath: '/en/ai-transparency',
    pageKey: 'aiTransparency',
    priority: 0.7,
    changefreq: 'monthly',
    schemas: ['Organization', 'BreadcrumbList'],
    ogImage: '/og/default.png',
  ...
  {
    ptPath: '/apresentacao/login',
    enPath: '/en/presentation/login',
    pageKey: 'presentationLogin',
    priority: 0.0,
    changefreq: 'monthly',
    schemas: [],
    ogImage: '/og/default.png',
