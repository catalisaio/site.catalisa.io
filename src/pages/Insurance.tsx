...
function InsuranceROICalculator({ t, locale }: { t: (key: string) => string; locale: string }) {
    ...
    <Box bg="white" p={8} borderRadius="2xl" border="1px solid" borderColor="gray.200" boxShadow="lg">
      <VStack spacing={6} align="stretch">
        ...
        <SimpleGrid columns={{ base: 1, md: 3 }} spacing={4}>
          <FormControl>
            <FormLabel fontSize="sm">{t('roi.calc.fields.brokers')}</FormLabel>
            <Input
              type="number"
              value={brokers}
          ...
          <FormControl>
            <FormLabel fontSize="sm">{t('roi.calc.fields.claimsPerMonth')}</FormLabel>
            <Input
              type="number"
          ...
          <FormControl>
            <FormLabel fontSize="sm">{t('roi.calc.fields.costPerClaim')}</FormLabel>
            <Input
              type="number"
              value={costPerClaim}
...
const complianceIcons = [FiShield, FiLock, FiFileText, FiShield];
const complianceColors = ['green.400', 'blue.400', 'purple.400', 'orange.400'];
const capabilityIcons = [FiCamera, FiFileText, FiCpu, FiDollarSign, FiShield, FiUploadCloud];
const capabilityColors = ['purple.500', 'blue.500', 'green.500', 'yellow.600', 'red.500', 'brand.500'];
    ...
    <>
        ...
        <Container maxW="1280px">
          <VStack spacing={6} textAlign="center" maxW="800px" mx="auto">
            ...
            <SimpleGrid columns={{ base: 2, md: 3 }} spacing={6} pt={4}>
              <VStack>
                <Text fontSize="3xl" fontWeight="800" color="white">{t('hero.stats.stat1.value')}</Text>
            ...
            >
              ...
              >
                <VStack align="flex-start" spacing={3}>
                  <Badge colorScheme="purple" fontSize="2xs">{t(`market.insurers.${i}.highlight`)}</Badge>
                  <Heading as="h3" size="sm" fontWeight="700">{t(`market.insurers.${i}.name`)}</Heading>
                  <Text color="gray.500" fontSize="sm" lineHeight="1.6">{t(`market.insurers.${i}.description`)}</Text>
                </VStack>
              </Box>
            </MotionBox>
          ))}
      ...
      <SectionWrapper>
        ...
        <Box bg="purple.50" p={6} borderRadius="xl" mt={8} textAlign="center" border="1px solid" borderColor="purple.100">
          <Text color="gray.700" fontSize="md" fontWeight="500">
            <Text as="span" fontWeight="700" color="purple.700">{t('capabilities.pipelineLabel')}</Text>{' '}
      ...
      <SectionWrapper bg="gray.50">
        ...
        <Box maxW="900px" mx="auto">
          <InsuranceROICalculator t={t} locale={locale} />
        </Box>
      </SectionWrapper>
