...
export const allNamespaces = [
  ...
  'presentation', 'presentation-admin', 'press-kit', 'terms', 'security', 'pricing', 'how-it-works', 'whatsapp-integration', 'playbooks', 'seo', 'apps', 'casos-de-uso', 'ai-agents-whatsapp', 'insights', 'ai-transparency', 'training', 'determinism', 'vtex-day-2026',
] as const;
